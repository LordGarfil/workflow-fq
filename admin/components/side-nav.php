<!-- <nav class="slide-bar"> -->
    ...
    >
      ...
      >
        ...
        <div class="sidebar-brand-text main-sidebar-item"><strong>WORK FLOW</strong></div>
      </a>
      ...
      <li class="nav-item active">
        <a class="nav-link" id="dashboard-item" href="">
      ...
      <li class="nav-item">
        ...
        >
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="./views/login.php
            ">Login</a>
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" id="users-item" href="#">
